...
pub enum Resizing {
    ...
    VideoPreviewSplitSecondary(f32, f32),
...
pub struct StateData {
    ...
    pub video_preview_left_width: f32,
    pub video_preview_middle_width: f32,
    pub video_preview_visible: bool,
...
impl Default for StateData {
    fn default() -> Self {
        ...
        Self {
            ...
            video_preview_left_width: cfg.video_preview_left_width.max(160.0),
            video_preview_middle_width: cfg.video_preview_middle_width.max(160.0),
